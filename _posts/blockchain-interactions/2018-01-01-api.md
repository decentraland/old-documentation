...
```json
{
  "ok": true,
  "data": {
    "decimal": "1.15792089237316195423570985008687907837276713420356456256678977458620023701475e+77",
    "hex": "0xffffffffffffffffffffffffffffffd0ffffffffffffffffffffffffffffffe3"
  }
}
```

```
GET /parcels/:tokenId/decodedId
```

### Description

Returns the coordinates by the parcel blockchain id (token id)
...
```
GET /parcels/115792089237316195423570985008687907837276713420356456256678977458620023701475/decodedId
```

```
GET /parcels/1.15792089237316195423570985008687907837276713420356456256678977458620023701475e+77/decodedId
```

```
GET /parcels/0xffffffffffffffffffffffffffffffd0ffffffffffffffffffffffffffffffe3/decodedId
```
