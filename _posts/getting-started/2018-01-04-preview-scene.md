...
If your scene excedes any of the [scene limitations]({{ site.baseurl }}{% post_url /scene-coding-guide/2018-01-06-scene-limitations %}), for example if there are too many triangles in it, the scene won't be rendered. If this occurs, a warning sign will be rendered in the space where your scene should be, detailing the problem.
