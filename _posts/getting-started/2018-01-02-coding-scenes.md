...
See [Entity interfaces]({{ site.baseurl }}{% post_url /scene-coding-guide/2018-06-21-entity-interfaces %}) for a reference of all the available constructors for predefined entities and all of the supported components of each.
