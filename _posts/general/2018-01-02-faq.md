...
Estate is, as a LAND, a non-fungible digital asset. Estate is an association of two or more directly adjacent parcels of LAND. These parcels must be directly adjacent, and cannot be separated by a road, plaza, or any other parcel. By connecting parcels into Estates, you can more easily manage your larger LAND holdings. Estates are especially useful when building larger scenes that span more than one parcel.
