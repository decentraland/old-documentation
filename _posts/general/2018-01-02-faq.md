...
Land parcels are 10m x 10m, or 33ft x 33ft. Height is restricted based on [these limitations]{{ site.baseurl }}{% post_url /sdk-reference/2018-01-06-scene-limitations %}).
