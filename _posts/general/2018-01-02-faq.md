...
Yes. Visit the <a href="https://avatars.decentraland.org/">Avatars</a> page to claim it. All you need is an installed digital wallet and at least 100 MANA to burn. Another alternative is to buy a name in the <a target="_blank" href="https://market.decentraland.org/">Decentraland Marketplace</a>.
...
- The <a href="https://docs.decentraland.org/decentraland/faq/builder.decentraland.org">Builder</a> is an easy drag and drop visual tool. You have access to a large library of pre-made items, including interactive items that react to player feedback. You can also import and use your own custom 3D models.
