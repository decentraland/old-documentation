...
See [Entity interfaces]({{ site.baseurl }}{% post_url /scene-coding-guide/2018-06-21-entity-interfaces %}) for more details on these types of entities.
...
See [entity interfaces]({{ site.baseurl }}{% post_url /scene-coding-guide/2018-06-21-entity-interfaces %}) for a full list of all the properties that can be configured in a material. Keep in mind that all materials and textures must be within the parameters of the [scene limitations]({{ site.baseurl }}{% post_url /scene-coding-guide/2018-01-06-scene-limitations %}).
