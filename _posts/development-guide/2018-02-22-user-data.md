...
To get a user's Ethereum public key, use the `EthereumController` library. See [scene blockchain operations]({{ site.baseurl }}{% post_url /blockchain-integration/2018-01-07-scene-blockchain-operations %}) for details.
