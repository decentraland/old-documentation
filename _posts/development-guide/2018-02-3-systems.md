...
Most of the time, you won't want a system's update function to iterate over the entire set of entities in the scene, as this could be very costly in terms of processing power. To avoid this, you can create an [component group]({{ site.baseurl }}{% post_url /development-guide/2018-02-2-component-groups %}) to keep track of which are the relevant entities, and then have your system iterate over that list.
...
See [entity positioning]({{ site.baseurl }}{% post_url /development-guide/2018-02-5-set-entity-position %}) for examples of how to use `dt` to make movement smoother.
