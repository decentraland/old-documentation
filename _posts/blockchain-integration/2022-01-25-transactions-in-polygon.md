...
Another way is through Decentralized or Centralized exchanges. You can check https://polygon.technology/matic-token/ to see which exchanges operate with MATIC. It is important that if you want to use a Centralized exchange, make sure that it allows withdrawals through the Polygon network.
